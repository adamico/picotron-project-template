...
local array_same, find, every, assign =
    ...
    function (collection, item, compare_func)
        for key, value in pairs(collection) do
            if (compare_func(key, value, item)) then return value end
        end
        return nil
    end,
    ...
    function (collection, check_func)
        for key, value in pairs(collection) do
            if (not check_func(value, key, collection)) then return false end
        end
        return true
    end,
